<div id="who-we-serve-icons-content">
	...
	<div class="who-we-serve-icons-row">
		...
		<div class="who-we-serve-links">
			...
			<a href="<?=$url;?>/who-we-serve/reentry/index.php"><div id="reentry"><h3>Reentry</h3></div></a>
	...
	<div class="who-we-serve-icons-row">
		...
		<div class="who-we-serve-links">
			...
			<a href="<?=$url;?>/who-we-serve/victim-services/index.php"><div id="victim"><h3>Victim Services</h3></div></a>	
	
		</div>
		
		<div class="who-we-serve-links">
		
			<a href="<?=$url;?>/who-we-serve/workforce/index.php"><div id="workforce"><h3>Workforce</h3></div></a>
